...
var Collection = /*#__PURE__*/function () {
  ...
  _proto._notify = function _notify(operations) {
    var collectionChangeNotifySubscribers = function collectionChangeNotifySubscribers([subscriber]) {
      subscriber(operations);
    };
    this._subscribers.forEach(collectionChangeNotifySubscribers);
    this.changes.next(operations);
    var collectionChangeNotifyModels = function collectionChangeNotifyModels({
      record: record,
      type: type
    }) {
      if (type === 'updated') {
