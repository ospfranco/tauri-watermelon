...
var Database = /*#__PURE__*/function () {
  ...
  _proto.batch = function batch(...records) {
    return new Promise(function ($return, $error) {
      ...
      return Promise.resolve(this.adapter.batch(batchOperations)).then(function ($await_5) {
        try {
  ...
  _proto._notify = function _notify(changes) {
    ...
    var databaseChangeNotifySubscribers = function databaseChangeNotifySubscribers([tables, subscriber]) {
  ...
  _proto.unsafeResetDatabase = function unsafeResetDatabase() {
    return new Promise(function ($return, $error) {
      ...
      try {
        ...
        // Clear the database
        return Promise.resolve(adapter.unsafeResetDatabase()).then(function ($await_7) {
          try {
