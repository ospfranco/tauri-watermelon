...
var Model = /*#__PURE__*/function () {
  ...
  _proto.update = function update(recordUpdater = _noop.default) {
    return new Promise(function ($return, $error) {
      ...
      return Promise.resolve(this.db.batch(this)).then(function ($await_1) {
        try {
  ...
  _proto.prepareUpdate = function prepareUpdate(recordUpdater = _noop.default) {
    ...
    if (process.env.NODE_ENV !== 'production' && typeof process !== 'undefined' && process && process.nextTick) {
      process.nextTick(function () {
        (0, _invariant.default)(_this._preparedState !== 'update', "record.prepareUpdate was called on ".concat(_this.table, "#").concat(_this.id, " but wasn't sent to batch() synchronously -- this is bad!"));
      });
    }
    return this;
  }
  ...
  _proto.markAsDeleted = function markAsDeleted() {
    return new Promise(function ($return, $error) {
      ...
      return Promise.resolve(this.db.batch(this.prepareMarkAsDeleted())).then(function ($await_2) {
        try {
          return $return();
        } catch ($boundEx) {
          return $error($boundEx);
  ...
  _proto.destroyPermanently = function destroyPermanently() {
    return new Promise(function ($return, $error) {
      ...
      return Promise.resolve(this.db.batch(this.prepareDestroyPermanently())).then(function ($await_3) {
        try {
          return $return();
        } catch ($boundEx) {
          return $error($boundEx);
    ...
    return new Promise(function ($return, $error) {
      ...
      return Promise.resolve((0, _helpers2.fetchDescendants)(this)).then(function ($await_4) {
        try {
          ...
          return Promise.resolve(this.db.batch(records)).then(function ($await_5) {
            try {
              return $return();
            } catch ($boundEx) {
              return $error($boundEx);
    ...
    return new Promise(function ($return, $error) {
      ...
      return Promise.resolve((0, _helpers2.fetchDescendants)(this)).then(function ($await_6) {
        try {
          ...
          return Promise.resolve(this.db.batch(records)).then(function ($await_7) {
            try {
              return $return();
            } catch ($boundEx) {
              return $error($boundEx);
  ...
  _proto.observe = function observe() {
    (0, _invariant.default)(this._preparedState !== 'create', "Cannot observe uncommitted record");
  ...
  _proto.__ensureNotDisposable = function __ensureNotDisposable(debugName) {
    (0, _invariant.default)(this._raw._status !== 'disposable', "".concat(debugName, " cannot be called on a disposable record"));
  };
