...
function unsafeLokiExpr(expr) {
  if (process.env.NODE_ENV !== 'production') {
    (0, _invariant.default)(expr && typeof expr === 'object' && !Array.isArray(expr), 'Value passed to Q.unsafeLokiExpr is not an object');
  }
  return {
    type: 'loki',
    expr: expr
...
var on = function on(table, leftOrClauseOrList, valueOrComparison) {
