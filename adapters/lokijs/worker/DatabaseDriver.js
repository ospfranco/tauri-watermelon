...
var DatabaseDriver = /*#__PURE__*/function () {
  ...
  _proto.setUp = function setUp() {
    return new Promise(function ($return, $error) {
      return Promise.resolve(this._openDatabase()).then(function ($await_9) {
        try {
          return Promise.resolve(this._migrateIfNeeded()).then(function ($await_10) {
            try {
              return $return();
            } catch ($boundEx) {
  ...
  _proto.unsafeExecute = function unsafeExecute(operations) {
    if (process.env.NODE_ENV !== 'production') {
      (0, _invariant.default)(operations && typeof operations === 'object' && Object.keys(operations).length === 1 && typeof operations.loki === 'function', 'unsafeExecute expects an { loki: loki => { ... } } object');
    }
  ...
  _proto.unsafeResetDatabase = function unsafeResetDatabase() {
    return new Promise(function ($return, $error) {
      return Promise.resolve((0, _lokiExtensions.deleteDatabase)(this.loki)).then(function ($await_11) {
        try {
          this.cachedRecords.clear();
          _logger.default.log('[Loki] Database is now reset');
          return Promise.resolve(this._openDatabase()).then(function ($await_12) {
            try {
              this._setUpSchema();
              return $return();
            } catch ($boundEx) {
        ...
        if (dbVersion === 0) {
          ...
          if (dbVersion > 0 && dbVersion < schemaVersion) {
            ...
            if (migrationSteps) {
              ...
              try {
                return Promise.resolve(this._migrate(migrationSteps)).then(function ($await_15) {
                  try {
                    return $Try_4_Post();
                  } catch ($boundEx) {
              ...
              return Promise.resolve(this.unsafeResetDatabase()).then(function ($await_16) {
                try {
                  return $If_8.call(this);
                } catch ($boundEx) {
                  return $error($boundEx);
            ...
            return Promise.resolve(this.unsafeResetDatabase()).then(function ($await_17) {
              try {
                return $If_7.call(this);
              } catch ($boundEx) {
                return $error($boundEx);
