...
function diagnoseSyncConsistencyImpl({
  ...
  return new Promise(function ($return, $error) {
    ...
    log('Syncing once...');
    return Promise.resolve(synchronize()).then(function ($await_7) {
      try {
        log('Syncing twice...');
        return Promise.resolve(synchronize()).then(function ($await_8) {
          try {
            log('Synced.');
                                      ...
                                      try {
                                        ...
                                        .get(table).query().fetch()).then(function ($await_14) {
                                          try {
                                            ...
                                            return Promise.resolve(yieldLog()).then(function ($await_15) {
                                              try {
                                                inconsistentRecords = [];
                                                excessRecords = [];
                                                missingRecords = [];
                                                return Promise.resolve((0, _forEachAsync.default)(Array.from(remoteMap.entries()), function ([id, remote]) {
                                                  ...
                                                  try {
                                                    return Promise.resolve(yieldLog()).then(function ($await_18) {
                                                      try {
                                                        ...
                                                        return Promise.resolve((0, _forEachAsync.default)(Array.from(localMap.entries()), function ([id, record]) {
                                                          ...
                                                          try {
                                                            ...
                                                            log();
                                                            return Promise.resolve(yieldLog()).then(function ($await_22) {
                                                              try {
                                                                return $return();
                                                              } catch ($boundEx) {
                                                                return $error($boundEx);
